...
import student.Access.Sen;
import student.util.Functions;

// Represents +, -, *, /, %
public class BinaryArithmeticOperator extends Expression<Expression<?>> implements Binary { // need not be abstract
	//private Expression left, right;
	...
	/**
	 * Creates a new BinaryArithmeticOperator with the given left and right expressions
	 * and a randomly generated BinaryOp
	 * @param l the given left
	 * @param r the given right
	 */
